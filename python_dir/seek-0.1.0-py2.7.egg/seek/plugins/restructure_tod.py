...
class Plugin(BasePlugin):
    ...
    def __call__(self):
        ...
        # print("pix_numbers = {} | cntr.keys() = {}".format(np.array(pix_numbers).shape, np.array(cntr.keys()).shape))
        # self.ctx.restructured_tod_pixels = pix_numbers      # Agora o SEEK considera os pixels repetidos.
