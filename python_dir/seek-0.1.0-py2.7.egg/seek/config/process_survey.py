...
# mesmo mapa sem RFI, sem mascara, sem artefatos, GANHO = 1 na pasta data |sem background_removal
...
strategy_end   = "2018-01-01-23:59:00"      # survey end time. Format YYYY-mm-dd-HH:MM:SS

spectrometer = "fake_bingo_spectrometer"
data_file_prefix = "bingo_tod_horn_27_"                 # First part of fit file name
...
integration_frequency = 30                   # no of pixel to use for integration in freq (axis=0)

coord_prefix = "coord_bingo_27_"                    # prefix of coord file
