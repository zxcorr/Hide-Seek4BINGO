...
# ==================================================================
file_prefix = "/home/otobone/Documentos/ic/projeto_karin/resultados/TOD/freq_bleien/ame/celeste/"

integration_time = 1                 # no of pixel to use for integration in time (axis=1)
integration_frequency = 30#20           # no of pixel to use for integration in freq (axis=0)
max_frequency = 1260#1260
min_frequency = 960#990
...
spectrometer = "fake_bingo_spectrometer" #"M9703A"
data_file_prefix = "bingo_tod_horn_0_"                 # First part of fit file name
data_file_suffix = ".h5"          # Suffix of file name
file_type = "hdf5"

coord_prefix = "coord_bingo_0_"                    # prefix of coord file

chunk_size = 24                              # number of files to be grouped together  ?
...
accumulations = 146484                      # number of spectrum accumulations                           #O que sao esses numeros?
...
# ==================================================================
cleaner = "seek.mitigation.sum_threshold"                               #e possivel retirar rfi?
...
gain_file_default = "data/gain_template_null.dat" #"data/gain_template_7m_FFT_phase_switch_ADU_K.dat"
