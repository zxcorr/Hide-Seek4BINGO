...
class Plugin(BasePlugin):
    ...
    def __call__(self):
        ...
        # print(self.ctx.params.data_file_prefix)
        # print(self.ctx.params.file_prefix)
        
        # print(self.ctx.params.data_file_suffix)
        # print(pattern)
